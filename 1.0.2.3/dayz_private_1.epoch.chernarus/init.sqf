...
//BTC FAST ROPE
sleep 1; _fast_rope = [] execVM "addons\BTC\BTC_fast_roping_init.sqf";
//Custom addons
[] ExecVM "addons\airport.sqf";
[] ExecVM "addons\airport2.sqf";
[] ExecVM "addons\lost.sqf";
[] ExecVM "addons\city.sqf";
